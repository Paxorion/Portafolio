...
import "./beams.css" // Ensure this path is correct
...
const Beams = ({
  ...
  const beamMaterial = useMemo(
    () =>
      extendMaterial(THREE.MeshStandardMaterial, {
        // Header used by BOTH shaders ─ contains only shared stuff.
        header: `
  varying vec3 vEye;
  ...
  ${noise}
        ...
        // Vertex-only helpers go here so they DON’T get injected in the fragment shader.
        vertexHeader: `
