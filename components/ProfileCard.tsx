...
const DEFAULT_BEHIND_GRADIENT =
  "radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(240,10%,20%,var(--card-opacity)) 4%,hsla(240,10%,15%,calc(var(--card-opacity)*0.75)) 10%,hsla(240,10%,10%,calc(var(--card-opacity)*0.5)) 50%,hsla(240,10%,5%,0) 100%),radial-gradient(35% 52% at 55% 20%,#00c1ffff 0%,#073aff00 100%),radial-gradient(100% 100% at 50% 50%,#c137ffff 1%,#073aff00 76%),conic-gradient(from 124deg at 50% 50%,#00c1ffff 0%,#c137ffff 40%,#c137ffff 60%,#00c1ffff 100%)"

const DEFAULT_INNER_GRADIENT = "linear-gradient(145deg,rgba(0,0,0,0.6) 0%,rgba(0,0,0,0.2) 100%)"

const DEFAULT_CODE_ICON_SVG =
